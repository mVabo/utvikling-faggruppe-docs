...
The Spaceship class should define all the properties a player can have and contain a constructor
...
Our example contains multiple constructors for various situations, maybe you could cut it down to only need one?

:::

```cs title="./Models/Spaceship.cs"
